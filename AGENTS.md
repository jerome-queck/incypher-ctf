...
repository must live under `$HOME` for the `/state` mount to reach. **An unattended reboot does
not currently recover** — FileVault rules out automatic login, and ADR-0012 holds the trade.
