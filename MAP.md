...
| Domain language | The glossary — ubiquitous language and the boundaries between Run, Attempt, Lane, Lease, Submission epochs, Recovery, Tool profiles, Incidents and owned work | `CONTEXT.md` |
